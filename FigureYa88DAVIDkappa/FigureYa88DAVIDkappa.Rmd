...
library(ape) # 邻接法构建进化树 Neighbor-Joining method for phylogenetic tree construction
library(ggtree) # 进化树 visualization of phylogenetic tree
library(scales) # 颜色调色板 color palettes
library(ggplot2) # 数据可视化 data visualization
library(patchwork) # 组合多个ggplot2图形 Combine multiple ggplot2 plots
library(ggplotify) # 将非ggplot对象转换为ggplot对象 Convert non-ggplot objects to ggplot objects
...
## 计算Kappa value，用它来衡量注释之间的相似性 Calculate Kappa value to measure the similarity between annotations
