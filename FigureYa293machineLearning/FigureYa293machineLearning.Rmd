...
From <https://www.nature.com/articles/s41467-022-28421-6>
...
library(randomForestSRC) # 随机生存森林 Random Survival Forest
library(glmnet) # 弹性网回归 Elastic Net Regression
library(plsRcox) # 偏最小二乘回归 PLS Regression
library(superpc) # 超级主成分分析 Super Principal Component Analysis
library(gbm) # 梯度提升机 Gradient Boosting Machine
library(CoxBoost) # Cox提升回归 Cox Boosting Regression
library(survivalsvm) # 生存支持向量机 Survival Support Vector Machine
library(dplyr) # 数据操作 Data Manipulation
library(tibble) # 数据框操作 Data Frame Manipulation
library(BART) # 贝叶斯加性回归树 Bayesian Additive Regression Trees
library(miscTools) # 杂项工具 Miscellaneous Tools
library(compareC) # 比较C指数 Compare C-index
library(ggplot2) # 数据可视化 Data Visualization
library(ggsci) # 科学插图 Scientific Illustrations
library(tidyr) # 数据整理 Data Tidying
library(ggbreak) # 图形断点 Graph Breaks
library(ComplexHeatmap) # 复杂热图 Complex Heatmaps
...
### 图B - Lasso作图 Figure B - Lasso plot
...
### 图A - C指数的热图 Figure A - Heatmap of C-indices
...
### 图C - 模型比较 Figure C - Model Comparison
