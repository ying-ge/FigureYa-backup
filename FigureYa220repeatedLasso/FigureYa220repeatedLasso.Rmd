...
## 用训练集筛基因 Sifting genes with training sets
...
## 训练集 - 计算risk score和C指数 Training Set - Calculate the risk score and C-index
...
## 测试集 - 计算riskscore和C指数 Test Set - Calculate riskscore and C index
