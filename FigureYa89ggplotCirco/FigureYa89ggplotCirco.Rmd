...
### 首先画外面的3个环 First, draw the three outer rings
...
### 添加log2FC的坐标轴及刻度文字 Add coordinate axis and scale text for log2FC
...
### 画`P_value`热图 Draw a 'P_value' heatmap
...
### 画P value的图例 Draw a legend for P value
