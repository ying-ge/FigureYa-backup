...
#' \code{.theme_nocart} is a function that removes cartesian axis elements from the theme
#' This is used when creating ternary plots to avoid conflicts with ternary axis elements
#' @keywords internal
