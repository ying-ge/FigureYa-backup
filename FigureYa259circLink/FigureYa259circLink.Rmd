...
### 1. 快速预览 Take a glance of the data
...
### 2. 按通路将靶点转换为圆形分布 Transform the targets into circle by pathways
...
## 附：示例数据生成过程 Appendix: Example Data Generation Process
