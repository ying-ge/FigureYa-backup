...
Figure 3.Area under the curves (AUC) of the baseline, baseline cir-
culating tumour cell (CTC) and CTC progression survival models.
...
library(timeROC) # 时间依赖型ROC曲线分析 time-dependent ROC curve analysis
