...
library(mclust) # 高斯混合模型 # Gaussian mixture model
library(miRBaseVersions.db) # miRNA版本转换 # miRNA version conversion
library(miRBaseConverter)   # miRNA版本转换 # miRNA version conversion
library(pROC) # AUC计算 # AUC calculation
library(SimDesign) # 静默运行函数 # silent running function
...
## 正常与癌旁的差异表达 Differential expression of normal and adjacent cancer
...
## 运行高斯混合模型，并画图 Run the Gaussian mixture model and draw it
