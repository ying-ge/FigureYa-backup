...
## 相关性的计算 Calculation of correlation

### 计算每两种细胞间的相关性 Calculate the correlation between every two types of cells
...
### 计算相关性分析的P值 Calculate the P-value for correlation analysis
...
### 计算节点间的连接关系 Calculate the connection relationship between nodes
...
## 利用矩阵文件进行细胞的聚类 Cluster cells using matrix files
...
## 构建网络的input文件 Build the input file for the network
