...
## 输入文件的获得 Obtaining the input file
...
### 自定义配色，直接出图 Customize the color scheme and plot directly
...
### 按例文配色，然后后期加背景色 Follow the example color scheme, then add a background color later
