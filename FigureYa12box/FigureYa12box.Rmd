...
### 1. 基因表达量列表 Gene expression list
...
### 2. 差异表达的基因名列表 list of differentially expressed gene names
...
### 1. 多组画在同一个绘图区域 multiple groups in the same drawing area
...
### 2. 多个小图拼成一个大图 Multiple small images into one large image
