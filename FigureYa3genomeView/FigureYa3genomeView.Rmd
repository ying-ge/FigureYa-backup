...
library(Gviz) #基因组可视化 library for genome visualization
library(RColorBrewer) #颜色库 library for color library
library(TxDb.Hsapiens.UCSC.hg38.knownGene) #基因组数据库 genome database
```
