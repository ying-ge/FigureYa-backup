...
1. The impact of continuous variables on risk may be non-linear, and ignoring this non-linear effect can interfere with the results;
...
library(smoothHR) # 进行平滑HR计算 smoothed HR calculation
library(survival) # 生存分析 survival analysis
library(Hmisc) # 受限三次样条 restricted cubic spline
...
## 开始计算 Start calculating

### 寻找样条knot数 Find spline knot number
...
### 拟合Cox比例风险回归模型 Fit Cox proportional hazards regression model
