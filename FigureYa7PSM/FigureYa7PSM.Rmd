...
### 生成患者人群 Generate a patient population
...
### 生成正常对照人群 Generate a normal control population
...
## 生成CASE-CONTROL一一配对的格式 Generate CASE-CONTROL one-to-one matching format
