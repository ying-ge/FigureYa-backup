...
# 检查并安装 KMsurv（survMisc 的依赖）
# Check and install KMsurv (dependency of survMisc)
if (!requireNamespace("KMsurv", quietly = TRUE)) {
  cat("KMsurv 包未安装，正在自动安装...\n")
  cat("KMsurv package not installed, installing automatically...\n")
  install.packages("KMsurv", repos = "https://cloud.r-project.org/")
}
