...
### 将详细突变的MAF文件转化为二元突变矩阵 Convert a MAF file of detailed mutations into a binary mutation matrix

先自定义个函数 Let's customize a function.
...
### 计算免疫浸润 Calculating immune infiltration
```{r}
# 从免疫基因集中提取唯一的细胞类型
...
## 样本聚类提取距离 Sample clustering extraction distance
...
如果嫌点太多，可以通过取bin来缩减点的数量，可参考FigureYa73batchCorrelation。
