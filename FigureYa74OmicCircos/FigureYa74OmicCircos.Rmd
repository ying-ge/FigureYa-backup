...
支持hg18、hg19、mm9、mm10，例如像例文那样展示多个芯片基因的表达变化和之间的link关系

Support hg18, hg19, mm9, mm10, for example, displaying the expression changes of multiple chip genes and the link relationships between them as in the example text
...
### 方法一：单独画染色体名字 Method 1: Draw chromosome names separately
...
### 方法二：修改包里的代码 Method 2: Modify the code in the package
