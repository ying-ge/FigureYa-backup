...
目前只能通过手动来做，是否可以帮忙做一个续惯的流程。输入survival信息，和不同的临床亚组。
...
## 以一个亚组为例 Take a subgroup as an example
...
自定义函数，给一个筛选标准，直接画图。支持单次操作。

Custom function. Give a filtering criterion and plot directly. Supports single operations
