...
From <https://ascopubs.org/doi/full/10.1200/JCO.2017.76.9901>
...
这里用base plot画，你也可以尝试用ggplot2来画。
...
### 按需求者提供的草图draft来画 Draw according to the draft provided by the demander
...
### 按例文example来画 Draw according to the example text
