...
### 加载训练集数据 —— GSE364 Load the training set data - GSE364
...
## 用训练集定义候选基因集 Define the candidate gene set with the training set 
...
## 在两个测试集里寻找预后判断力都好的基因集合 Look for a set of genes with good prognostic judgment in both test sets
