...
library(reshape2) # 用于数据转换 # For data transformation
library(ggplot2) # 用于画图 # For drawing
library(scales) # 用于调色 # For color adjustment
library(cowplot) # 用于拼图 # For puzzle
...
## 按risk score分组 Group by risk score
