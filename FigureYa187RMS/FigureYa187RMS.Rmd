...
From <https://onlinelibrary.wiley.com/doi/full/10.1111/cpr.12861>
...
library(survcomp) # C-index比较 C-index comparison
library(survRM2) # 限制性平均生存时间计算 Restricted mean survival time calculation
...
## 多变量cox模型得到新的score The multivariate cox model has obtained a new score
