...
## 左右连线（列之间） Left and right lines (between columns)
...
## 上下左右连线（行、列之间） Lines connecting up, down, left and right (between rows and columns)
...
## 复现原图 Reproduce the original image
...
## 附：示例数据生成过程 Attached: Sample data generation process
