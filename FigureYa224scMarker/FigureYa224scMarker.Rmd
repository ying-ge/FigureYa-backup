...
## 结合每个cluster的marker基因和生物学知识确定细胞类型，顺便画图A Determine the cell type by combining the marker gene and biological knowledge of each cluster, and draw Figure A by the way
...
## C - Average cell number and relative proportion
