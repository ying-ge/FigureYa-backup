...
library(Seurat) # 单细胞分析核心包 # Core package for single cell analysis
library(magrittr) # 管道操作符 # Pipe operator
library(tidyverse) # 数据整理和可视化 # Data collation and visualization
library(ggplot2) # 绘图核心包 # Core package for drawing
library(ggpubr) # ggplot2的增强包 # Enhanced package of ggplot2
library(rstatix) # 统计检验包 # Statistical test package
library(RColorBrewer) # 颜色调色板 # Color palette
...
### 复现原文 Reproduce the original text
...
## 附：单细胞RNA-seq数据预处理 Attached: Single-cell RNA-seq data preprocessing
...
### 下载单细胞RNA-seq数据 Download single-cell RNA-seq data (downloaded from Microcloud, so no more download here)
