...
## cox回归筛选与OS有关的基因 Cox regression to screen genes related to OS
...
## 随机森林进一步降维 Random forests are further dimensionally reduced
...
## 排列组合确定最优签名及log-rank检验 Permutations and combinations determine the optimal signature and log-rank test
