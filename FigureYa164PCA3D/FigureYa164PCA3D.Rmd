...
From <https://n.neurology.org/content/86/24/2226>
...
library(rgl) # 3D绘图工具 The 3D plotting tool
...
```{r}
## 读取基因表达矩阵 Read the gene expression matrix
...
## 读取参与特定通路的基因 Read genes involved in a specific pathway
