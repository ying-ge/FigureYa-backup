...
用于分子分型，用 PC1 将样本分为高/低两组，后面可以再验证两组的生存、免疫特征差异。

Used for molecular typing, using PC1 to divide samples into high/low groups, and then verify the survival and immune characteristics of the two groups.
