...
From <https://doi.org/10.1007/s12035-018-1416-y>
...
library(pec) # 预测误差曲线 Prediction error curve
...
## 构建模型用于time-dependent c-index的比较 Build a model for the comparison of time-dependent c-index
