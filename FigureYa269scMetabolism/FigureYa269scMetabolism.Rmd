...
library(SeuratData) # Seurat示例数据集 Seurat example datasets
library(patchwork) # 多图合并 Multiple plot layout
library(RColorBrewer) # 调色板 Color palettes
library(pheatmap) # 热图绘制 Heatmap plotting
library(dplyr) # 数据处理 Data manipulation
library(magrittr) # 管道操作 Pipe operations
library(scMetabolism) # 单细胞代谢分析 Single-cell metabolism analysis
library(ggplot2) # 数据可视化 Data visualization
library(rsvd) # 快速SVD计算 Fast SVD computation
...
## 输入文件预处理 Input File Preprocessing
