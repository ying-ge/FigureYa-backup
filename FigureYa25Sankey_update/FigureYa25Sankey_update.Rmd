...
library(ggalluvial) # 画桑基图 draw sankey
...
### 后一层继承前一层的关系 The latter layer inherits the relationship of the former layer
...
### 后面多层继承第一层的关系（作者：Xiaofan Lu） Multiple layers behind inherit the relationship of the first layer
